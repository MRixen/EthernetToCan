#pragma once
// USER DEFINED
const byte BYTES_TO_READ_MCP2515 = 0x08;
const byte BYTES_TO_SEND_MCP2515 = 0x08;
const long MAX_WAIT_TIME_MCP2515 = 10000;
const int MAX_ERR_CNTR_MDSWCH_MCP2515 = 3;
byte incoming_data[BYTES_TO_READ_MCP2515];
byte outgoing_data[BYTES_TO_SEND_MCP2515];
